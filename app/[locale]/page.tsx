  ...
  return (
    <main id="main-content" className="bg-brand-surface">
      <section className="relative overflow-hidden bg-[linear-gradient(135deg,#081120_0%,#0f2138_48%,#1d312d_100%)] text-white">
        ...
        <div className="page-shell grid min-h-[calc(100svh-5rem)] items-end gap-12 py-14 sm:py-16 lg:grid-cols-[minmax(0,1.05fr)_minmax(360px,0.95fr)] lg:items-center lg:py-20">
          <div className="reveal-up relative z-10 max-w-3xl space-y-8">
            ...
            <div className="space-y-5">
              <p className="text-sm font-semibold uppercase tracking-[0.34em] text-white/62">{copy.home.hero.eyebrow}</p>
              <h1 className="max-w-[11ch] text-balance text-[clamp(2.7rem,9vw,6.4rem)] font-bold leading-[0.92]">
                {copy.home.hero.title}
              </h1>
              <p className="max-w-2xl text-base leading-8 text-white/80 md:text-lg">{copy.home.hero.description}</p>
            </div>
            ...
            <div className="grid gap-4 border-t border-white/12 pt-6 md:grid-cols-3">
              {copy.home.stats.map((stat) => (
                <div key={stat.label} className="space-y-2">
                  ...
                  <p className="text-sm leading-7 text-white/70">{stat.note}</p>
                </div>
              ))}
            </div>
          </div>

          <div className="reveal-up reveal-delay-1 relative z-10 overflow-hidden rounded-[34px] bg-[linear-gradient(180deg,#fffdf9_0%,#f8f1e7_100%)] p-5 text-brand-night shadow-[0_28px_70px_rgba(6,10,22,0.3)] md:p-7">
            <div className="space-y-5">
              <div>
              ...
              <div className="space-y-4">
                {copy.home.detailCards.map((item) => {
                  ...
                  return (
                    <div key={item.label} className="section-panel-quiet hover-lift rounded-[24px] bg-white p-4">
              ...
              <div className="rounded-[24px] border border-brand-line bg-brand-night px-5 py-4 text-white">
                <p className="text-xs font-semibold uppercase tracking-[0.22em] text-brand-lime">{contactLabel}</p>
      ...
      <section className="section-divider bg-brand-paper section-space">
        <div className="page-shell grid gap-10 lg:grid-cols-[minmax(0,0.94fr)_minmax(320px,0.82fr)] lg:gap-16">
          <PublicSectionHeading
          ...
          <div className="space-y-4">
            {copy.home.sponsorValue.bullets.map((bullet) => (
              <div key={bullet} className="section-panel hover-lift grid grid-cols-[auto_minmax(0,1fr)] gap-4 rounded-[24px] bg-white p-5">
            ...
            <div className="section-panel-dark rounded-[26px] p-6 text-white">
          ...
          <div className="grid gap-10 p-6 md:p-8 lg:grid-cols-[minmax(0,0.94fr)_minmax(320px,0.82fr)] lg:gap-14 lg:p-12">
            ...
            <div className="space-y-4">
              ...
              >
                ...
                <ArrowRight className="size-5 transition motion-safe:group-hover:translate-x-1" />
              </a>
              <a
