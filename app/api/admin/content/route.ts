...
import { getSupabaseAdminClient, SITE_CONTENT_ROW_ID } from "@/lib/supabase";
...
export async function GET(request: Request) {
  ...
  if (!client) {
    return NextResponse.json({ message: "Supabase environment variables belum diatur." }, { status: 500 });
  }
