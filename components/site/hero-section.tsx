...
export function HeroSection({ content, registrationUrl }: HeroSectionProps) {
  ...
  return (
    <section className="relative overflow-hidden pt-36 text-white md:pt-44">
      ...
      <div className="section-shell hero-grid relative items-end pb-14 md:pb-20">
        <div className="space-y-8">
          ...
          <div className="space-y-5">
            <p className="text-sm font-semibold uppercase tracking-[0.32em] text-white/66">
              {content.eventName}
            </p>
            <h1 className="max-w-[11ch] text-balance text-[clamp(3rem,8vw,6.25rem)] font-bold leading-[0.95]">
              {content.heroHeadline}
            </h1>
            <p className="max-w-2xl text-balance text-base leading-7 text-white/78 md:text-lg">
          ...
          <div className="flex flex-wrap items-center gap-3">
            ...
            <a
              href="#harga"
              className="inline-flex items-center justify-center gap-2 rounded-full border border-white/16 bg-white/10 px-5 py-3 text-sm font-semibold text-white transition hover:border-white/28 hover:bg-white/14"
            >
        ...
        <div className="hero-track soft-noise relative overflow-hidden rounded-[34px] border border-white/12 bg-white/6 p-6 shadow-[0_32px_70px_rgba(8,12,24,0.3)] backdrop-blur-xl md:p-8">
          ...
          <div className="relative z-10 flex min-h-[430px] flex-col justify-between">
            ...
            <div className="space-y-4">
              ...
              <h2 className="max-w-[7ch] text-[clamp(3rem,8vw,5.5rem)] font-bold leading-[0.9]">
                FUN RUN
              </h2>
